...
(map (function systemf) 
      ...
      *home-directory* *version* *maximum-print-sequence-size* *printer* *macros* *os* *release* @v @p @s 
      ...
      fix file fail fail! fail-if fwhen findall false explode external exception eval-kl eval error-to-string error 
      empty? element? dump dumped do difference destroy defun define defmacro defcc defprolog declare datatype cut 
